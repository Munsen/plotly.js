...
- using CDN URL https://cdn.plot.ly/plotly-latest.min.js OR https://cdn.plot.ly/plotly-1.20.4-1.min.js

or as raw javascript:
- using dist file `dist/plotly.js`
- using CDN URL https://cdn.plot.ly/plotly-latest.js OR https://cdn.plot.ly/plotly-1.20.4-1.js
...
| CDN URL (tagged) | https://cdn.plot.ly/plotly-basic-1.20.4-1.js |
| CDN URL (tagged minified) | https://cdn.plot.ly/plotly-basic-1.20.4-1.min.js |
| CommonJS | `require('plotly.js/lib/index-basic')` |

| Raw size | Minified size | Minified + gzip size |
|------|-----------------|------------------------|
| 1.6 MB | 606.1 kB | 196.3 kB |
...
| CDN URL (tagged) | https://cdn.plot.ly/plotly-cartesian-1.20.4-1.js |
| CDN URL (tagged minified) | https://cdn.plot.ly/plotly-cartesian-1.20.4-1.min.js |
| CommonJS | `require('plotly.js/lib/index-cartesian')` |

| Raw size | Minified size | Minified + gzip size |
|------|-----------------|------------------------|
| 1.8 MB | 676.8 kB | 217.6 kB |
...
| CDN URL (tagged) | https://cdn.plot.ly/plotly-geo-1.20.4-1.js |
| CDN URL (tagged minified) | https://cdn.plot.ly/plotly-geo-1.20.4-1.min.js |
| CommonJS | `require('plotly.js/lib/index-geo')` |

| Raw size | Minified size | Minified + gzip size |
|------|-----------------|------------------------|
| 1.6 MB | 634.7 kB | 207 kB |
...
| CDN URL (tagged) | https://cdn.plot.ly/plotly-gl3d-1.20.4-1.js |
| CDN URL (tagged minified) | https://cdn.plot.ly/plotly-gl3d-1.20.4-1.min.js |
| CommonJS | `require('plotly.js/lib/index-gl3d')` |

| Raw size | Minified size | Minified + gzip size |
|------|-----------------|------------------------|
| 2.5 MB | 1 MB | 333.1 kB |
...
| CDN URL (tagged) | https://cdn.plot.ly/plotly-gl2d-1.20.4-1.js |
| CDN URL (tagged minified) | https://cdn.plot.ly/plotly-gl2d-1.20.4-1.min.js |
| CommonJS | `require('plotly.js/lib/index-gl2d')` |

| Raw size | Minified size | Minified + gzip size |
|------|-----------------|------------------------|
| 2.2 MB | 955.3 kB | 296.4 kB |
...
| CDN URL (tagged) | https://cdn.plot.ly/plotly-mapbox-1.20.4-1.js |
| CDN URL (tagged minified) | https://cdn.plot.ly/plotly-mapbox-1.20.4-1.min.js |
...
| CDN URL (tagged) | https://cdn.plot.ly/plotly-finance-1.20.4-1.js |
| CDN URL (tagged minified) | https://cdn.plot.ly/plotly-finance-1.20.4-1.min.js |
| CommonJS | `require('plotly.js/lib/index-finance')` |

| Raw size | Minified size | Minified + gzip size |
|------|-----------------|------------------------|
| 1.6 MB | 631.4 kB | 203.2 kB |
